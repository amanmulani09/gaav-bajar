-- Accept image MIME types up to 10 MiB. Private-bucket and ownership rules stay in place.
update storage.buckets set file_size_limit=10485760, allowed_mime_types=array['image/*'] where id='listing-photos';
